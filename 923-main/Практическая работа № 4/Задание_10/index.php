...
<head>
	...
	<style>
		...
		h1, h2, h3 { color: #333; }
		.section { margin-bottom: 40px; padding: 15px; background: #fafafa; border: 1px solid #ddd; }
	</style>
</head>
<body>

	<h1>Управляющие конструкции</h1>
	<h2>Циклы (Оптимизация сценариев)</h2>
	<hr>

	<?php
	// === БЛОК ДАННЫХ (Вместо подключения внешнего файла) ===
	...
	<!-- СЕКЦИЯ 1: Вывод массива рок-групп ($team) -->
	<div class="section">
		<h2>Вывод массива рок-групп</h2>
		<?php
	...
	<!-- СЕКЦИЯ 2: Вывод массива музыкальных треков ($track) -->
	<div class="section">
		<h2>Вывод массива треков</h2>
		<?php
			$li = "";
